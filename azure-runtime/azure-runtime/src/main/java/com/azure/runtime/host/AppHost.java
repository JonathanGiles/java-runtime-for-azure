...
/**
 * The AppHost interface is the primary entry point for users to interact with the Java Runtime for Azure framework. It
 * provides methods for booting the apphost, running it locally, and generating a manifest file for the apphost.
 */
